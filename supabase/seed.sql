...
--
-- IMPORTANT: Illustrative sample listings for the MVP. Prices, availability,
-- and stores are approximate and NOT live data. The UI labels recommendations
-- built on this data as "estimated". Replace with real, verified listings
-- before relying on them. Prices in KWD, sized around a ~250 KWD budget.
-- specs_json matches the LaptopSpecs TypeScript shape in lib/types.ts.
-- ===========================================================================

insert into public.laptop_listings
  (store_name, product_title, brand, model, price, currency, availability, url, country, city_or_area, specs_json, rating, review_count, source_type, last_checked_at)
values
('Xcite', 'Lenovo IdeaPad Slim 3 15', 'Lenovo', 'IdeaPad Slim 3', 165, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.3, 210, 'seed', now()),
('Best Al-Yousifi', 'HP Pavilion 15', 'HP', 'Pavilion 15-eg', 210, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.4, 188, 'seed', now()),
('Eureka', 'ASUS Vivobook 15', 'ASUS', 'Vivobook X1502', 155, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.1, 142, 'seed', now()),
('Xcite', 'Dell Inspiron 15 3520', 'Dell', 'Inspiron 3520', 175, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.2, 167, 'seed', now()),
('Best Al-Yousifi', 'Lenovo ThinkPad E14 Gen 5', 'Lenovo', 'ThinkPad E14', 245, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.6, 96, 'seed', now()),
('Eureka', 'HP 250 G9', 'HP', '250 G9', 120, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 3.9, 120, 'seed', now()),
('Xcite', 'Acer Aspire 5', 'Acer', 'Aspire A515', 185, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.3, 205, 'seed', now()),
('Best Al-Yousifi', 'ASUS Vivobook 16', 'ASUS', 'Vivobook X1605', 265, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.2, 88, 'seed', now()),
('Xcite', 'Apple MacBook Air M1', 'Apple', 'MacBook Air M1', 270, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.8, 540, 'seed', now()),
('Best Al-Yousifi', 'Apple MacBook Air M2 13"', 'Apple', 'MacBook Air M2', 330, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.8, 320, 'seed', now()),
('Xcite', 'Lenovo LOQ 15', 'Lenovo', 'LOQ 15IRH', 290, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.4, 130, 'seed', now()),
('Best Al-Yousifi', 'Acer Nitro 5', 'Acer', 'Nitro AN515', 330, 'KWD', 'preorder', null, 'Kuwait', 'الكويت',
 ...
 4.3, 175, 'seed', now()),
('Xcite', 'HP Victus 15', 'HP', 'Victus 15-fa', 300, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.2, 154, 'seed', now()),
('Marina Computer', 'Dell Latitude 5430 (Used)', 'Dell', 'Latitude 5430', 190, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.1, 64, 'seed', now()),
('Eureka', 'Lenovo V15 G3', 'Lenovo', 'V15 G3', 110, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 3.8, 90, 'seed', now()),
('Best Al-Yousifi', 'ASUS Zenbook 14 OLED', 'ASUS', 'Zenbook UX3402', 320, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.6, 140, 'seed', now()),
('Eureka', 'HP 14 (Celeron)', 'HP', '14-dq', 95, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 3.2, 58, 'seed', now()),
('Marina Computer', 'Lenovo IdeaPad Gaming 3 (2021)', 'Lenovo', 'IdeaPad Gaming 3', 230, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.0, 110, 'seed', now()),
('Xcite', 'Microsoft Surface Laptop Go 2', 'Microsoft', 'Surface Laptop Go 2', 240, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
 ...
 4.1, 76, 'seed', now()),
('Eureka', 'Huawei MateBook D15', 'Huawei', 'MateBook D15', 170, 'KWD', 'in_stock', null, 'Kuwait', 'الكويت',
