...
export const PROMPT_VERSION = "2026-06-30.v4";
...
- الأهم: للاستخدامات الاحترافية أو الإبداعية (تصميم، مونتاج فيديو، برمجة، هندسة، إنتاج موسيقى) اسأل دائماً عن أسماء البرامج المحدّدة التي سيستخدمها (مثلاً: فاينال كت، لوجيك برو، أدوبي بريمير، فوتوشوب، أوتوكاد، سوليدوركس). هذا أهم سؤال لأن بعض البرامج تعمل على نظام واحد فقط (فاينال كت ولوجيك برو على ماك فقط)، فهو يحدّد النظام والعتاد معاً — اجعله أول سؤال (sort_order 1).
- إذا كان النظام يؤثّر على هذا الاستخدام، فاسأل صراحةً: هل يفضّل/يحتاج نظام ماك (macOS) أم ويندوز؟ ووضّح أن بعض البرامج لا تعمل إلا على نظام معيّن.
- اعتمد على ما ذكره المستخدم بالفعل: إذا سمّى برنامجاً أو نظاماً فلا تتجاهله ولا تسأل عنه من جديد — ابنِ عليه.
...
أنشئ أسئلة المتابعة المناسبة لهذا الاستخدام تحديداً. مثال: إذا كان معلّماً اسأل عن البرامج التي يستخدمها (وورد/باوربوينت/منصات تعليمية)، وهل يحمل الجهاز يومياً، وهل يربطه بالبروجكتر. إذا كان طالباً اسأل عن الجامعة والتخصص والبرامج المتوقعة. وإذا كان مصمّماً أو محرّر فيديو أو مبرمجاً أو مهندساً أو منتج موسيقى فاجعل أول سؤال عن أسماء البرامج المحدّدة التي سيستخدمها، ثم اسأل عن نظام التشغيل المفضّل (ماك أم ويندوز) لأن بعض البرامج تعمل على نظام واحد فقط. اجعلها مناسبة لمستواه غير التقني.`;
}
